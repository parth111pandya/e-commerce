...
const Color primaryColor = Color(0xFF353F54);

List<ProductsModel> listofCartProdut = [];
List<ProductsModel> listofProdutLocallyStore = [];
List<CategoriesModel> listofCategoriesLocallyStore = [];

const MaterialColor primaryMaterialColor =
    MaterialColor(0xFF9581FF, <int, Color>{
  50: Color(0xFFeaedfc),
  100: Color(0xFFcbd5e7),
  200: Color(0xFFaeb8ce),
  300: Color(0xFF909cb6),
  400: Color(0xFF7a86a3),
  500: Color(0xFF637292),
  600: Color(0xFF556481),
  700: Color(0xFF45516a),
  800: Color(0xFF353f54),
  900: Color(0xFF222b3c),
});
